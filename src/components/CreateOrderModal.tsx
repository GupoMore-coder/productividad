      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-end sm:items-center justify-center">
          ...
          >
            ...
            <form onSubmit={handleSubmit(onFormSubmit)} className="flex-1 overflow-y-auto p-6 space-y-8 no-scrollbar pb-32">
            ...
            <div className="p-6 border-t border-white/5 bg-black/40 backdrop-blur-xl flex gap-3 shrink-0">
              ...
              <button type="submit" onClick={handleSubmit(onFormSubmit)} disabled={isSubmitting || uploadingPhotos} className="flex-[2] px-6 py-3.5 rounded-2xl bg-[#d4bc8f] text-slate-900 font-black text-[0.65rem] uppercase tracking-widest hover:brightness-110 transition-all flex items-center justify-center gap-2">
